   ...
   <div class="table-responsive">
      <table class="table table-bordered">
         ...
         <tbody>
            ...
            $kueri_order = mysqli_query($koneksi, "SELECT * FROM tbl_order,tbl_customer WHERE tbl_order.id_customer = tbl_customer.id_customer AND tbl_customer.id_customer =$id_customer ");
